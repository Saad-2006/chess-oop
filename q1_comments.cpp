...
// /**
//  * @brief Game state indicating ongoing game.
//  */
// const int GAME_NONE = 0;
// /**
//  * @brief Game state indicating checkmate (game ends with a winner).
//  */
// const int GAME_CHECKMATE = 1;
// /**
//  * @brief Game state indicating stalemate (game ends in a draw).
//  */
...
// /**
//  * @brief Converts a string to title case for pawn promotion input.
//  * @param input The input string to convert.
//  * @return The title-cased string (e.g., "queen" becomes "Queen").
//  */
...
// /**
//  * @class Displayable
//  * @brief Abstract interface for objects that can be displayed on the console.
//  */
// class Displayable {
// public:
//     /**
...
// class Position {
// private:
//     int row; ///< Row index (0-7, where 0 is top row, 7 is bottom).
...
//  * @return A Position object with row and column indices, or (-1, -1) if invalid.
//  */
...
//     int x, y;      ///< Position on the board (row, column).
//     bool hasMoved; ///< Flag indicating if the piece has moved.

// public:
//     /**
//      * @brief Constructs a ChessPiece with color and position.
//      * @param col The color ("White" or "Black").
...
//      * @param board The chessboard to validate the move.
//      * @param needsPromotion Set to true if the move triggers pawn promotion.
...
//      * @param targetX The target row index.
//      * @param targetY The target column index.
//      * @param board The chessboard to validate the attack.
...
//     /**
//      * @brief Gets the piece's row index.
//      * @return The row index.
//      */
//     int getX() const { return x; }

//     /**
//      * @brief Gets the piece's column index.
//      * @return The column index.
//      */
//     int getY() const { return y; }

//     /**
//      * @brief Sets the piece's position and marks it as moved.
//      * @param newX The new row index.
//      * @param newY The new column index.
//      */
...
// public:
//     /**
//      * @brief Constructs a Pawn with color and position.
//      * @param col The color ("White" or "Black").
//      * @param xPos The row index.
//      * @param yPos The column index.
//      */
...
//     /**
//      * @brief Gets the pawn's Unicode symbol.
//      * @return "♟" for White, "♙" for Black.
//      */
...
// public:
//     /**
//      * @brief Constructs a Rook with color and position.
//      * @param col The color ("White" or "Black").
//      * @param xPos The row index.
//      * @param yPos The column index.
//      */
...
//     /**
//      * @brief Gets the rook's Unicode symbol.
//      * @return "♜" for White, "♖" for Black.
//      */
//     string getSymbol() const { return color == "White" ? "♜" : "♖"; }
// };
...
// public:
//     /**
//      * @brief Constructs a Knight with color and position.
//      * @param col The color ("White" or "Black").
//      * @param xPos The row index.
//      * @param yPos The column index.
//      */
...
//     /**
//      * @brief Gets the knight's Unicode symbol.
//      * @return "♞" for White, "♘" for Black.
//      */
//     string getSymbol() const { return color == "White" ? "♞" : "♘"; }
// };
...
// public:
//     /**
//      * @brief Constructs a Bishop with color and position.
//      * @param col The color ("White" or "Black").
//      * @param xPos The row index.
//      * @param yPos The column index.
//      */
...
//     /**
//      * @brief Gets the bishop's Unicode symbol.
//      * @return "♝" for White, "♗" for Black.
//      */
//     string getSymbol() const { return color == "White" ? "♝" : "♗"; }
// };
...
// public:
//     /**
//      * @brief Constructs a Queen with color and position.
//      * @param col The color ("White" or "Black").
//      * @param xPos The row index.
//      * @param yPos The column index.
//      */
...
//     /**
//      * @brief Gets the queen's Unicode symbol.
//      * @return "♛" for White, "♕" for Black.
//      */
//     string getSymbol() const { return color == "White" ? "♛" : "♕"; }
// };
...
// public:
//     /**
//      * @brief Constructs a King with color and position.
//      * @param col The color ("White" or "Black").
//      * @param xPos The row index.
//      * @param yPos The column index.
//      */
...
//     /**
//      * @brief Gets the king's Unicode symbol.
//      * @return "♚" for White, "♔" for Black.
//      */
//     string getSymbol() const { return color == "White" ? "♚" : "♔"; }
// };
...
// /**
//  * @class Square
//  * @brief Represents a single square on the chessboard that may hold a piece.
//  */
// class Square {
// private:
//     ChessPiece* piece; ///< Pointer to the piece on this square, or nullptr if empty.
...
//     /**
//      * @brief Destructor that deletes the piece, if any.
//      */
//     ~Square() { delete piece; }

//     /**
//      * @brief Sets a piece on the square.
//      * @param p Pointer to the ChessPiece to place.
//      */
//     void setPiece(ChessPiece* p) { piece = p; }

//     /**
//      * @brief Gets the piece on the square.
//      * @return Pointer to the ChessPiece, or nullptr if empty.
//      */
...
// /**
//  * @class ChessBoard
//  * @brief Represents the chessboard, managing pieces, moves, and game state.
//  */
// class ChessBoard : public Displayable {
// private:
//     Square squares[8][8]; ///< 8x8 grid of squares.
//     int lastMoveFromX, lastMoveFromY; ///< Starting coordinates of the last move.
//     int lastMoveToX, lastMoveToY; ///< Ending coordinates of the last move.
//     bool lastMoveWasPawnTwoSquares; ///< Flag for pawn two-square moves (en passant).
//     int halfMoveClock; ///< Half-moves since last pawn move or capture.
//     string positionHistory[1000]; ///< History of board positions for repetition.
//     int positionCount; ///< Number of positions in history.

//     /**
//      * @brief Generates a unique hash of the current board state.
//      * @return A string representing the board, castling rights, and en passant target.
//      */
...
//     /**
//      * @brief Destructor for the ChessBoard.
//      */
//     ~ChessBoard() {}
...
//      * @return Pointer to the ChessPiece, or nullptr if none or out of bounds.
//      */
...
//      * @param x The row index.
//      * @param y The column index.
//      * @param piece Pointer to the ChessPiece to place.
//      */
...
//     /**
//      * @brief Checks if castling is possible for a given color and side.
...
//     /**
//      * @brief Checks if the game is over for a given color.
//      * @param color The color of the player to check ("White" or "Black").
//      * @return GAME_NONE if ongoing, GAME_CHECKMATE if checkmate, GAME_STALEMATE if stalemate.
//      */
...
//      * @param pieceType The type of piece to promote to ("Queen", "Rook", "Bishop", "Knight").
...
//      * @return True if 100 half-moves have passed without a capture or pawn move, false otherwise.
//      */
...
//     /**
//      * @brief Updates move history for en passant and draw detection.
//      * @param fromX The starting row index.
//      * @param fromY The starting column index.
//      * @param toX The ending row index.
//      * @param toY The ending column index.
...
//      * @param x The row index.
//      * @param y The column index.
//      * @return The algebraic notation (e.g., "e4").
//      */
...
//     /**
//      * @brief Gets the row index of the last move's destination.
//      * @return The row index.
//      */
//     int getLastMoveToX() const { return lastMoveToX; }

//     /**
//      * @brief Gets the row index of the last move's origin.
//      * @return The row index.
//      */
...
// class Move {
// private:
//     int fromX, fromY; ///< Starting coordinates.
//     int toX, toY;     ///< Ending coordinates.

// public:
//     /**
//      * @brief Constructs a Move with start and end coordinates.
//      * @param fx The starting row index.
//      * @param fy The starting column index.
//      * @param tx The ending row index.
//      * @param ty The ending column index.
//      */
//     Move(int fx, int fy, int tx, int ty) : fromX(fx), fromY(fy), toX(tx), toY(ty) {}

//     /**
//      * @brief Gets the starting row index.
//      * @return The row index.
//      */
//     int getFromX() const { return fromX; }

//     /**
//      * @brief Gets the starting column index.
//      * @return The column index.
//      */
//     int getFromY() const { return fromY; }

//     /**
//      * @brief Gets the ending row index.
//      * @return The row index.
//      */
//     int getToX() const { return toX; }

//     /**
//      * @brief Gets the ending column index.
//      * @return The column index.
//      */
...
//     int pieceCount;            ///< Number of pieces.

// public:
//     /**
//      * @brief Constructs a Player with a given color.
//      * @param col The color ("White" or "Black").
//      */
...
//      * @param piece Pointer to the ChessPiece to add.
//      */
...
//      * @return Pointer to the array of pieces.
//      */
...
// /**
//  * @class Game
//  * @brief Manages the overall chess game, including players and turns.
//  */
// class Game {
// private:
...
//     /**
//      * @brief Initializes players by assigning pieces from the board.
//      */
...
//     /**
//      * @brief Runs the main game loop, handling input and game flow.
//      */
//     void startGame() {
//         bool gameOver = false;
//         while (!gameOver) {
...
//     /**
//      * @brief Executes a move, handling captures, castling, and promotion.
...
// /**
//  * @brief Moves a pawn to a new position, handling promotion and en passant.
//  * @param newX The target row index.
//  * @param newY The target column index.
//  * @param board The chessboard to validate the move.
//  * @param needsPromotion Set to true if the move triggers promotion.
//  * @return True if the move is valid, false otherwise.
//  */
...
// /**
//  * @brief Checks if a pawn can attack a target position.
//  * @param targetX The target row index.
//  * @param targetY The target column index.
//  * @param board The chessboard (unused for pawn attack).
...
//  * @param newY The target column index.
//  * @param board The chessboard to validate the move.
//  * @param needsPromotion Always set to false (rooks don't promote).
//  * @return True if the move is valid, false otherwise.
//  */
...
// /**
//  * @brief Checks if a rook can attack a target position.
//  * @param targetX The target row index.
//  * @param targetY The target column index.
//  * @param board The chessboard to validate the attack.
...
//  * @param newY The target column index.
//  * @param board The chessboard to validate the move.
//  * @param needsPromotion Always set to false (knights don't promote).
//  * @return True if the move is valid, false otherwise.
//  */
...
// /**
//  * @brief Checks if a knight can attack a target position.
//  * @param targetX The target row index.
//  * @param targetY The target column index.
//  * @param board The chessboard (unused for knight attack).
...
//  * @param newY The target column index.
//  * @param board The chessboard to validate the move.
//  * @param needsPromotion Always set to false (bishops don't promote).
//  * @return True if the move is valid, false otherwise.
//  */
...
// /**
//  * @brief Checks if a bishop can attack a target position.
//  * @param targetX The target row index.
//  * @param targetY The target column index.
//  * @param board The chessboard to validate the attack.
...
//  * @param newY The target column index.
//  * @param board The chessboard to validate the move.
//  * @param needsPromotion Always set to false (queens don't promote).
//  * @return True if the move is valid, false otherwise.
//  */
...
// /**
//  * @brief Checks if a queen can attack a target position.
//  * @param targetX The target row index.
//  * @param targetY The target column index.
//  * @param board The chessboard to validate the attack.
...
//  * @param newY The target column index.
//  * @param board The chessboard to validate the move.
//  * @param needsPromotion Always set to false (kings don't promote).
//  * @return True if the move is valid, false otherwise.
//  */
...
// /**
//  * @brief Checks if a king can attack a target position.
//  * @param targetX The target row index.
//  * @param targetY The target column index.
//  * @param board The chessboard (unused for king attack).
